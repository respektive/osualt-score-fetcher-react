  ...
  >
    <Grid item sx={{ pt: 10, pl: 25, pr: 25}}>
        <Paper sx={{ padding: 5}}>
            ...
            <Button variant="contained" href="https://osu.ppy.sh/oauth/authorize?client_id=37221&redirect_uri=https://osualt.respektive.pw/api/oauth&response_type=code&scope=identify%20public">Login with osu!</Button>
